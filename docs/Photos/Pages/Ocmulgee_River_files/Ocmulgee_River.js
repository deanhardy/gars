...
{return IWCreatePhotocast("http://www.georgiariversurvey.org/georgiariversurvey.org/Photos/Pages/Ocmulgee_River_files/rss.xml",true,true);}
...
IWLayoutPhotoGrid('id4',new IWPhotoGridLayout(3,new IWSize(180,180),new IWSize(180,0),new IWSize(216,195),27,27,0,new IWSize(6,6)),new IWPhotoFrame([IWCreateImage('Ocmulgee_River_files/comic-1_01.png'),IWCreateImage('Ocmulgee_River_files/comic-1_02.png'),IWCreateImage('Ocmulgee_River_files/comic-1_03.png'),IWCreateImage('Ocmulgee_River_files/comic-1_06.png'),IWCreateImage('Ocmulgee_River_files/comic-1_09.png'),IWCreateImage('Ocmulgee_River_files/comic-1_08.png'),IWCreateImage('Ocmulgee_River_files/comic-1_07.png'),IWCreateImage('Ocmulgee_River_files/comic-1_04.png')],null,0,1.000000,4.000000,4.000000,1.000000,1.000000,5.000000,5.000000,6.000000,6.000000,71.000000,115.000000,71.000000,115.000000,null,null,null,0.500000),imageStream,range,null,null,1.000000,{backgroundColor:'#000000',reflectionHeight:100,reflectionOffset:2,captionHeight:100,fullScreen:0,transitionIndex:2},'../../Media/slideshow.html','widget0','widget1','widget2')});}
...
loadMozillaCSS('Ocmulgee_River_files/Ocmulgee_RiverMoz.css')
...
adjustLineHeightIfTooBig('id5');adjustFontSizeIfTooBig('id5');adjustLineHeightIfTooBig('id6');adjustFontSizeIfTooBig('id6');fixAllIEPNGs('../../Media/transparent.gif');Widget.onload();fixupIECSS3Opacity('id7');initializeMediaStream_id4()
